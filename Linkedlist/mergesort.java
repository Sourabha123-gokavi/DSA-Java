...
public class mergesort {
    ...
    // helper function to find the mid
    ...
    public static NODE merge(NODE head1,NODE head2){
        LinkedList Ml=new LinkedList(-1);
        NODE temp=Ml;
        ...
        // to merge the remaining left part of the list 
        while(head1!=null){
            temp.next=head1;
            head1=head1.next;
            temp=temp.next;
    ...
    public static NODE Merge_sort(NODE head){
        ...
        // then call for the merge sort for the left and right part
